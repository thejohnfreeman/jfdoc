define(function (require) {
  ...
  Decl.prototype.mergeDoclet = function mergeDoclet(doclet) {
    if (!doclet) return;
    if (this.doclet && this.doclet.isExplicit) {
      /* Do not overwrite explicit doclets with inferred ones. */
      if (!doclet.isExplicit) return;
