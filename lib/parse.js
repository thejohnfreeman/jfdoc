(function () {
  ...
  Parser.prototype.setQualName = function setQualName(decl, qualName) {
    if (qualName.length > 1) decl.scopeQuals = qualName.slice(0, -1);
    decl.baseName = qualName[qualName.length - 1];
  };
